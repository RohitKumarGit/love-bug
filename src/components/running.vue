<template>
<div>
    <b-button variant="danger" style="margin-top:1rem;" @click="verifyadd" v-show="verifyshow==true">
        Verify address
    </b-button>
    ...
    <div @click="convert" class="my-div scrollbar" id="style-3">
     ...
     <p v-if="selected==='easy'" v-html="easyprob"></p>
     <p v-if="selected==='medium'" v-html="mediumprob"></p>
     <p v-if="selected==='hard'" v-html="hardprob"></p>
    </div>
    </b-col>
    <b-col cols="6">
        <ide>
